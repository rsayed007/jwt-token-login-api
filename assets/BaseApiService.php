...
class BaseApiService
{
    ...
    public function __construct()
    {
        ...
        if ('login' != strtolower($this->serviceName)) {
            $this->validateToken();
        }
    }
    ...
    /**
     * api request and type validation 
     */
    public function validateRequest()
    {
        ...
        if (!isset($data['api_type']) || $data['api_type'] == "") {
            $this->throwError(API_NAME_REQUIRED, "API Type is required.");
        }
        $this->serviceName = $data['api_type'];

        if (!is_array($data['data'])) {
            $this->throwError(API_PARAM_REQUIRED, "API data is required.");
        }
    ...
    public function processApi($className = null)
    {
        try {
            $api = new $className;
